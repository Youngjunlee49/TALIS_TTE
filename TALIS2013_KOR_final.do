* ======================================================================
* TALIS 2013 SOUTH KOREA FINAL PROJECT
...
************************************************************************
	...
	use "TALIS2013KOR_MERGED.dta", clear	
	d, short //n=2,933
	codebook IDSCHOOL //number of school=177
...
foreach p of var TT2G21A1 TT2G21B1 TT2G21C1 TT2G21G TT2G21H TT2G21I {
	...
	*DESCRIPTIVE STATISTICS
	...
	save "TALIS2013KOR_CLEAN.dat", replace 
...
************************************************************************
	cap log close
	set linesize 80		
	use "TALIS2013KOR_CLEAN.dat", clear
...
foreach i of var pd1 pd2 pd3 pd4 pd5 pd6 pd7 pd8 {
	...
	* #1 Multilevel Logistic model *
	...
	/*outreg2 [`i'm0 `i'm1 `i'm2 `i'm3 `i'm4] using "meglmResults_KOR_conwt.xls", append dec(3) eform */
	}
...
foreach i of var pd1 pd2 pd3 pd4 pd5 pd6 pd7 pd8 {
	...
	* #1 Multilevel Logistic model *
	...
	estimates store `i'm4
	/*outreg2 [`i'm0 `i'm1 `i'm2 `i'm3 `i'm4] using "LogitResults_OR_KOR_unconwt.xls", append dec(3) eform */
	}
