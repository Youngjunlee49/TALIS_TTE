* ======================================================================
* TALIE 2013 JAPAN FINAL PROJECT
...
************************************************************************
	...
	use "TALIS2013JAP_MERGED.dta", clear	
	d, short //n=3,484
	codebook IDSCHOOL //number of school=192
...
foreach p of var TT2G21A1 TT2G21B1 TT2G21C1 TT2G21G TT2G21H TT2G21I {
	...
	* SCHOOL CONTEXT FACTORS
	...
	global SCFAC 	"PUBLIC METRO SIZE STRATIO"  // 4 school context factors
	...
	*DESCRIPTIVE STATISTICS
	...
	keep if!missing(FEMALE, PERMANENT, TWORKYEAR, TEACHTIME, NEEDDIVERSE, ///
					NEEDSUBEDU, STEM, PUBLIC, METRO, SIZE, STRATIO, ///
					PWORKYEAR, PINSLEADS, PSCMUTRS, PLACKPER, PLACKMAT)
	
	save "TALIS2013JAP_CLEAN.dat", replace 
...
************************************************************************
	...
	use "TALIS2013JAP_CLEAN.dat", clear
	cap log close
	set linesize 80		
	log using "final project_0413_JAP.log", replace

	global pdlist "pd1 pd2 pd3 pd6 pd7 pd8"	
	global TFAC     "FEMALE PERMANENT TWORKYEAR TEACHTIME NEEDDIVERSE NEEDSUBEDU STEM"  // 7 
	global SCFAC 	"PUBLIC METRO SIZE STRATIO"  // 4 school context factors
	global SOFAC	"PWORKYEAR PINSLEADS PSCMUTRS PLACKPER PLACKMAT" // 5 school organizational factors

*******With rescaled level-1 weights; conditional weight for teachers*******	
	* #0 Logistic model *
foreach i of var pd1 pd2 pd3 pd6 pd7 pd8 {
	...
	* #1 Multilevel Logistic model *
	...
	outreg2 [`i'm0 `i'm1 `i'm2 `i'm3 `i'm4] using "meglmResults_JAP_conwt.xls", append dec(3) eform
	}
...
foreach i of var pd1 pd2 pd3 pd4 pd5 pd6 pd7 pd8 {
	...
	* #1 Multilevel Logistic model *
	...
	estimates store `i'm4
	outreg2 [`i'm0 `i'm1 `i'm2 `i'm3 `i'm4] using "LogitResults_OR_JAP_unconwt.xls", append dec(3) eform
	}
	
log close

translate final project_0413_JAP.log final project_0413_JAP_log.pdf
